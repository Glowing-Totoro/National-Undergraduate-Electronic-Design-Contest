...
#define USART4_TX_GPIO_CLK_ENABLE()          do{ __HAL_RCC_GPIOC_CLK_ENABLE(); }while(0)   /* PB口时钟使能 */

#define USART4_RX_GPIO_PORT                  GPIOC
#define USART4_RX_GPIO_PIN                   GPIO_PIN_11
#define USART4_RX_GPIO_CLK_ENABLE()          do{ __HAL_RCC_GPIOC_CLK_ENABLE(); }while(0)   /* PB口时钟使能 */

#define USART4_UX                            UART4
#define USART4_UX_IRQn                       UART4_IRQn
#define USART4_UX_IRQHandler                 UART4_IRQHandler
#define USART4_UX_CLK_ENABLE()               do{ __HAL_RCC_UART4_CLK_ENABLE(); }while(0)  /* USART3 时钟使能 */
...
#define USART4_EN_RX                 1           /* 使能（1）/禁止（0）串口3接收 */
...
extern uint8_t g_rx_buffer4[RXBUFFERSIZE4];       /* HAL库USART接收Buffer */
